...
test.describe("Project Management", () => {
  ...
  test("should search projects", async ({ authenticatedPage }) => {
    ...
    await expect(authenticatedPage.locator("text=Alpha Project")).not.toBeVisible();
    await expect(authenticatedPage.locator("text=Gamma Project")).not.toBeVisible();
  });
  ...
  test("should delete a project", async ({ authenticatedPage }) => {
    ...
    await expect(authenticatedPage.locator(`text=${projectName}`)).not.toBeVisible();
  });
});
