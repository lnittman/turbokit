					...
					>
						...
						<div className="flex flex-col sm:flex-row gap-4">
							<Link
								...
								className="inline-flex items-center justify-center rounded-md bg-primary text-primary-foreground h-11 px-5 text-base font-medium"
							>
								Get Started
							...
							<Link
								href="/docs/convex"
								className="inline-flex items-center justify-center rounded-md border h-11 px-5 text-base font-medium"
							>
								Learn Convex
							</Link>
						</div>
				...
				>
					<div className="relative z-10 flex flex-col items-center text-center space-y-6 max-w-[750px] mx-auto text-white">
						...
						<div className="flex gap-4">
							<Link
								href="/docs"
								className="inline-flex items-center justify-center rounded-md bg-white/10 backdrop-blur h-11 px-5 text-base font-medium"
							>
