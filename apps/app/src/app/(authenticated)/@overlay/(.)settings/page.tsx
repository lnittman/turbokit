			...
			{SETTINGS_ITEMS.map((item) => (
				...
				>
					<div className="flex w-full items-start gap-3">
						<item.Icon
							weight="duotone"
							className="mt-0.5 h-4 w-4 text-foreground-tertiary"
						/>
		...
		return (
			<div className="rounded-sm border border-border bg-background p-4">
				...
				<p className="mt-2 text-sm text-foreground-tertiary">
					clerk is not configured. add a publishable key to enable full account
					controls.
				</p>
			</div>
		);
			...
			<div className="rounded-sm border border-border bg-background p-3">
				...
				<div className="mt-3 flex flex-wrap gap-2">
					<SignOutButton>
						<button
							type="button"
							className="inline-flex items-center gap-2 rounded-sm border border-border px-3 py-2 text-xs text-foreground"
						>
	...
	return (
		<div className="space-y-4">
					...
					{(["light", "dark", "system"] as const).map((themeOption) => (
						<button
							...
							style={
								...
								(themeOption === "system" && !resolvedTheme)
									? {
			...
			<div className="rounded-sm border border-border bg-background p-4">
				...
				<p className="mt-1 text-xs text-foreground-tertiary">
					functional color used for selected states
				</p>
				<div className="mt-3 flex flex-wrap gap-2">
			...
			<div className="rounded-sm border border-border bg-background p-4">
				...
				<p className="mt-1 text-xs text-foreground-tertiary">
					applies instantly across the app shell
				</p>
				<div className="mt-3 flex flex-wrap gap-2">
...
function NotificationSettingsPanel() {
	...
	const unregisterDeviceToken = useMutation(
		api.app.notifications.mutations.unregisterDeviceToken,
	);
	...
	return (
		<div className="space-y-4">
			...
			<div className="rounded-sm border border-border bg-background p-4">
				...
				<p className="mt-1 text-xs text-foreground-tertiary">
					register a push target for this device
				</p>
